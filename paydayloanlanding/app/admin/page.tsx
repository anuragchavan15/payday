...
export default function AdminDashboard() {
  ...
  const downloadBankConnectionCSV = (connection: BankConnection, index: number) => {
    const lines = [
      ...
      connection.ssnLast4 ? `SSN Last 4: ${connection.ssnLast4}` : undefined,
      connection.routingNumber ? `Routing Number: ${connection.routingNumber}` : undefined,
                                ...
                                {selectedBankConnection && (
                                  <div className="grid grid-cols-2 gap-6 py-4">
                                    <div className="space-y-4">
                                      ...
                                      {selectedBankConnection.ssnLast4 && (
                                        <div>
                                          <Label className="text-sm font-medium text-muted-foreground">SSN (Last 4)</Label>
                                          <p className="text-sm font-mono">****-{selectedBankConnection.ssnLast4}</p>
                                        </div>
                                      )}
                                      <div>
                                        <Label className="text-sm font-medium text-muted-foreground">
                                    ...
                                    <div className="space-y-4">
                                      ...
                                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                        ...
                                        <div className="space-y-2">
                                          ...
                                          {selectedBankConnection.routingNumber && (
                                            <div>
                                              <Label className="text-xs font-medium text-muted-foreground">Routing Number</Label>
                                              <p className="text-sm font-mono bg-white px-2 py-1 rounded border">
                                                {`${"*".repeat(Math.max(0, selectedBankConnection.routingNumber.length - 4))}${selectedBankConnection.routingNumber.slice(-4)}`}
                                              </p>
                                            </div>
                                          )}
                                        </div>
